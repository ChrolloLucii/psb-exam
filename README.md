...
После включения на vm SSH-сервера, для проверки доступности сервера подключился к машине ssh клиентом PUTTY.![msedge_l7bfw1wpOx.png](фоточки/msedge_l7bfw1wpOx.png)
