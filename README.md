...
Изначально на VM отсутствовал SSH-сервер. Установил его, включил ![VirtualBoxVM_qFSx09RUXx.png](фоточки/VirtualBoxVM_qFSx09RUXx.png)
После включения на vm SSH-сервера, для проверки доступности сервера подключился к машине ssh клиентом PUTTY.![[msedge_l7bfw1wpOx.png]]
...
![[Pasted image 20250911153427.png]]
...
![[Pasted image 20250911170230.png]]
### Задание 2
...
![[Pasted image 20250911171332.png]]
...
![[Pasted image 20250911200608.png]]
...
![[Pasted image 20250911171726.png]]
...
==0755 = rwxr-xr-x==
![[Pasted image 20250911172937.png]]
...
![[Pasted image 20250911173426.png]]
...
![[Pasted image 20250911174035.png]]
...
![[Pasted image 20250911181023.png]]
Теперь Команды
```bash
...
```
![[WindowsTerminal_fC9Zk7eUgx.png]]
...
![[Pasted image 20250911191933.png]]
![[Pasted image 20250911192009.png]]
...
![[Pasted image 20250911194733.png]]
...
![[Pasted image 20250911195453.png]]
#### Результат прохода ansible playbook
![[Pasted image 20250911200023.png]]
...
![[Pasted image 20250911201648.png]]
